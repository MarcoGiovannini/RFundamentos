...
# Sequencia de valores numéricos ou caracteres
...
# Coleção de vetores em linhas e colunas, sendo que todos os vetores devem ser do mesmo tipo de dados
...
# Conjunto de vetores, dataframes e matrizes
